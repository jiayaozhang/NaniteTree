...
class  Mesh_SimplificationParms  : public SOP_NodeParms
{
public:
    static int version() { return 1; }

    Mesh_SimplificationParms()
    {
        myDivs = 0;

    }

    explicit Mesh_SimplificationParms(const Mesh_SimplificationParms &) = default;

    ~Mesh_SimplificationParms() override {}

    bool operator==(const Mesh_SimplificationParms &src) const
    {
    ...
    {
        *this = *((const Mesh_SimplificationParms *)src);
    }
