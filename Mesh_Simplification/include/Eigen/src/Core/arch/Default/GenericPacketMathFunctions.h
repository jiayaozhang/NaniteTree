...
Packet psqrt_complex(const Packet& a) {
  ...
  // * If z is (x,+âˆ?), the result is (+âˆ?,+âˆ?) even if x is NaN
  // * If z is (x,-âˆ?), the result is (+âˆ?,-âˆ?) even if x is NaN
  // * If z is (-âˆ?,y), the result is (0*|y|,+âˆ?) for finite or NaN y
  // * If z is (+âˆ?,y), the result is (+âˆ?,0*|y|) for finite or NaN y
  ...
  // prepare packet of (+âˆ?,0*|y|) or (0*|y|,+âˆ?), depending on the sign of the infinite real part.
  ...
  // prepare packet of (+âˆ?,+âˆ?) or (+âˆ?,-âˆ?), depending on the sign of the infinite imaginary part.
  Packet is_imag_inf;
